    ...
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      {profile.whatsapp && !exclude.includes("whatsapp") && (
        <a
          ...
          rel="noopener noreferrer"
          aria-label="WhatsApp"
          className="flex h-10 w-10 items-center justify-center rounded-lg border border-dark-700 text-dark-400 transition-all hover:scale-110 hover:border-[#25D366] hover:text-[#25D366] active:scale-95"
        >
